		...
		?>
            ...
            <div class="update-nag notice wip-custom-login-notice">
            	...
            	<div class="wip-custom-login-noticedescription">
					...
					<?php printf( '<a href="%1$s" class="dismiss-notice">'. __( 'Dismiss this notice', 'wip-custom-login' ) .'</a>', esc_url( '?wip_customlogin-dismiss=1' ) ); ?>
                </div>
                
                <a target="_blank" href="<?php echo esc_url( 'https://www.themeinprogress.com/c-login-free-custom-login-wordpress-plugin/?ref=2&campaign=wip-custom-login-notice' ); ?>" class="button"><?php _e( 'Upgrade to the premium version.', 'wip-custom-login' ); ?></a>
                <div class="clear"></div>
